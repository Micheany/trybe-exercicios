...
//capslock nos elementos do array
...
const emailList = [
  ...
  btnFilter.addEventListener("click", () => showEmailList(emailList)); //observar que ele passou parametro para a função no addEventListener, mas perdeu o event
